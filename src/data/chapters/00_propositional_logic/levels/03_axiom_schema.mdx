...
import { weakening } from "/src/logic/AxiomSchema";
...
You can also click the axiom schema in the inventory to auto-fill `axiom $weakening `.
</LocalizedMarkdown>
<LocalizedMarkdown locale="zh">
...
你也可以点击物品栏里的公理模式来自动填写 `axiom $weakening `。
</LocalizedMarkdown>
</Speak>
